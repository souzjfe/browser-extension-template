...
// Measured in pixels.
var EPSILON_VIDEO = 18;
// Measured in meters.
var EPSILON_VIDEO_WORLD = 0.01;
// ref:
...
jasmine_util_1.describeWithFlags('MediaPipeHands', jasmine_util_1.ALL_ENVS, function () {
    var timeout;
    beforeAll(function () {
...
jasmine_util_1.describeWithFlags('MediaPipeHands static image ', jasmine_util_1.BROWSER_ENVS, function () {
    var detector;
    var image;
    var timeout;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    timeout = jasmine.DEFAULT_TIMEOUT_INTERVAL;
                    jasmine.DEFAULT_TIMEOUT_INTERVAL = 120000; // 2mins
                    return [4 /*yield*/, test_util_2.loadImage('hands.jpg', 720, 382)];
                case 1:
                    image = _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    test_util_1.expectArraysClose(keypoints, EXPECTED_HAND_KEYPOINTS_PREDICTION, EPSILON_IMAGE);
                    expect(tf.memory().numTensors).toEqual(beforeTensors);
                    detector.dispose();
                    expect(tf.memory().numTensors).toEqual(startTensors);
                    return [2 /*return*/];
...
jasmine_util_1.describeWithFlags('MediaPipe Hands video ', jasmine_util_1.BROWSER_ENVS, function () {
    var detector;
    var timeout;
    var expected;
    var expected3D;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, test_util_2.loadVideo('asl_hand.25fps.mp4', 25 /* fps */, callback, expected, constants_1.MEDIAPIPE_CONNECTED_KEYPOINTS_PAIRS, 0 /* simulatedInterval unused */)];
                case 2:
                    _a.sent();
